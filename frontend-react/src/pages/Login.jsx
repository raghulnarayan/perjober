      ...
      <div className="glass-card" style={{ width: '100%', maxWidth: '400px', padding: '40px' }}>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <input 
            ...
            required 
            style={{ padding: '12px', borderRadius: '8px', border: 'none', background: 'rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} 
          />
          <input 
            type="password" 
          ...
          <button 
            type="submit"
            disabled={loading}
            style={{ padding: '12px', borderRadius: '8px', border: 'none', background: 'linear-gradient(45deg, #bf953f, #aa771c)', color: 'black', fontWeight: 'bold', cursor: 'pointer' }}
          >
